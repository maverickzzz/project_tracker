...
const access = JSON.parse(props.data.access);
let form = useForm({
    name: props.data.name,
    access: {
        dashboard: access.dashboard,
        project_owners: access.project_owners,
        projects: access.projects,
        administration_user_groups: access.administration_user_groups,
        administration_users: access.administration_users,
        administration_companies: access.administration_companies,
        administration_settings: access.administration_settings,
    }
});

let submit = () => {
    form.put(`/usergroups/${props.data.id}`);
}
