<template>
    <Layout>
        <template #title>
            <h1 class="font-semibold text-lg dark:text-white-light">Projects - Create</h1>
        </template>
        <template #content>
            <form class="space-y-5" @submit.prevent="submit">
                <BaseInput :error="errors.name">
                    <label for="groupname">Project Name</label>
                    <input id="groupname" type="text" placeholder="Project Name" v-model="form.name" class="form-input" />
                </BaseInput>
                ...
                <BaseInput :error="errors.referrer">
                    ...
                    <input id="groupname" type="text" placeholder="Project Name" v-model="form.referrer" class="form-input" />
                </BaseInput>
                <BaseInput :error="errors.commission_fee">
                    <label for="">Commission Fee</label>
                    <input id="groupname" type="number" placeholder="Project Name" v-model="form.commission_fee" class="form-input" />
                </BaseInput>
                ...
                <div class="flex space-x-3">
                    ...
                    <Link href="/projects" class="btn btn-outline-primary outline">Cancel</Link>
                </div>
            </form>
        </template>
    </Layout>
