            ...
            <div class="panel m-6 w-full max-w-lg sm:w-[480px]">
                ...
                <form class="space-y-5" @submit.prevent="submit">
                    <div>
                        ...
                        <input id="email" type="email" class="form-input" placeholder="Enter Email" v-model="form.email" />
                    </div>
                    <div>
                        <label for="password">Password</label>
                        <input id="password" type="password" class="form-input" placeholder="Enter Password" v-model="form.password" />
                    </div>
                    <!-- <div>
                ...
                <ul class="mb-5 flex justify-center gap-2 sm:gap-5">
                    <li>
                        <button type="button" class="btn flex gap-1 bg-white-dark/30 text-black shadow-none hover:bg-white dark:border-[#253b5c] dark:bg-transparent dark:text-white dark:hover:bg-[#1b2e4b] sm:gap-2">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6 shrink-0" viewBox="0 0 256 193" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                <g>
                    ...
                    <li>
                        <button type="button" class="btn flex gap-1 bg-white-dark/30 text-black shadow-none hover:bg-white dark:border-[#253b5c] dark:bg-transparent dark:text-white dark:hover:bg-[#1b2e4b] sm:gap-2">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6 shrink-0" viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                <g>
                    ...
                    <li>
                        <button type="button" class="btn flex gap-1 bg-white-dark/30 text-black shadow-none hover:bg-white dark:border-[#253b5c] dark:bg-transparent dark:text-white dark:hover:bg-[#1b2e4b] sm:gap-2">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6 shrink-0" viewBox="0 0 256 209" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                <g>
                ...
                <p class="text-center">
                    Dont't have an account ? <a href="auth-boxed-signup.html" class="font-bold text-primary hover:underline">Sign Up</a>
                </p> -->
            </div>
        </div>
